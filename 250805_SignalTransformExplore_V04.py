...
if st.session_state.segmented_data:
    ...
    if st.session_state.observations:
        ...
        # --- Signal Intensity (dB) ---
        with tabs[5]:
            st.subheader("Signal Intensity (dB) Over Time (Spectrogram-like Defaults)")
